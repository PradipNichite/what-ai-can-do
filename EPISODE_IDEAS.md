...
1. Polish `Derivatives: How AI Learns From Mistakes`.
2. Create Marathi version of the derivative story.
3. Create the next applied-math episode: `Matrices: How Images Become Numbers`.
4. Draft career visual story: `Biology But Not Doctor`.
5. Draft career visual story: `Biotechnology vs Bioinformatics vs Food Technology`.

Later:

1. Build the AI-era career series.
2. Turn selected modules into video storyboards.
3. Test video generation pipeline with one completed 9:16 story.
