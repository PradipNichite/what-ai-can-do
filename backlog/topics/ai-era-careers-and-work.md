# AI-Era Careers And Work

Status: High-level topic track.

## Core Promise

Show how generative AI, creator economy, automation, no-code tools, and gig work are changing what a career can look like.

## Audience

High-school students, college students, early professionals, freelancers, parents, and small business owners.
...
| Prompt-Based Content Designer | Visual, ad, story, and explainer creation | [Open](../ideas/prompt-based-content-designer.md) |
| AI Automation Consultant | Help small businesses automate repeatable work | [Open](../ideas/ai-automation-consultant-small-business.md) |
| Data Storyteller | Turn reports into decisions | [Open](../ideas/data-storyteller.md) |
| Local-Language AI Educator | Teach AI in Marathi and local contexts | [Open](../ideas/local-language-ai-educator.md) |
| Personal Knowledge Manager | Organize notes, documents, and learning systems | [Open](../ideas/personal-knowledge-manager.md) |
| Gig Economy With AI | AI lowers entry barriers, judgment still matters | [Open](../ideas/gig-economy-with-ai.md) |

## Best Formats

- Mobile-first career cards
- Day-in-the-life visual story
- Skill map
- Portfolio example
- Video storyboard
...
Keep familiar work words in English where natural: creator, freelancer, gig, client, content, prompt, portfolio, automation, dashboard, website, report, and tool.

## Next Step

Create a visual overview that maps traditional careers, AI-assisted careers, creator work, and service businesses side by side.
